...
export const time = () => {
    ...
    const [openhouseDiv, marriageDiv, receptionDiv] = timeContainer.querySelectorAll('div div');
    ...
    openhouseDiv.innerHTML = createTimeListItem('OpenHouse', data.time.marriage);
